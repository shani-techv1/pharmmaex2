      ...
      <div className={styles.container}>
        <div className={styles.inner}>
          ...
          <p className={styles.description}>
            ...
            and be part of an exclusive gathering of pharma professionals,
            innovators, and industry leaders. Complete the form below to
            register as a visitor and secure your entry pass.
          </p>
          <VideoSlider />
